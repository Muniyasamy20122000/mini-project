 ...
 */
 ...
 JTextField inputDate=new JTextField("ENTER DATE IN DD-MMYYYY",20); //TO INPUT DATE
...
Stuff\\NetBeans\\busmodfinal\\bus.jpg").getImage());
 ...
 try {
 if(svar.equals(dvar))
 JOptionPane.showMessageDialog(windowContent,"SOURCE AND
DESTINATION CANNOT BE
SAME","ERROR",JOptionPane.ERROR_MESSAGE);
 else {
 // patternList.addActionListener(listener1);
