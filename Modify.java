...
class modify {
 ...
 windowContent.setLayout(new BoxLayout(windowContent,
BoxLayout.PAGE_AXIS));
 ...
 frame.setIconImage(new ImageIcon("C:\\Rohit\\Java
Stuff\\NetBeans\\busmodfinal\\bus.jpg").getImage());
 ...
 {
 try{
 key=(String)JOptionPane.showInputDialog(windowContent,"ENTER
THE UNIQUE KEY","INPUT UNIQUE KEY", JOptionPane.PLAIN_MESSAGE,
null, null, "");
 }
 catch(NullPointerException t)
 {
 JOptionPane.showMessageDialog(windowContent,"PLEASE INPUT
THE KEY");
 }
...
finalType=(String)JOptionPane.showInputDialog(windowContent,"MODIFY BUS
TYPE","ENTER", JOptionPane.PLAIN_MESSAGE, null, possibilities, "");
...
finalsTime=(String)JOptionPane.showInputDialog(windowContent,"ENTER THE
NEW START TIME","ENTER", JOptionPane.PLAIN_MESSAGE, null, null, "");
 }
...
finaleTime=(String)JOptionPane.showInputDialog(windowContent,"ENTER THE
NEW END TIME","ENTER", JOptionPane.PLAIN_MESSAGE, null, null, "");
 }
...
finalPrice=(String)JOptionPane.showInputDialog(windowContent,"ENTER THE
NEW PRICE","ENTER", JOptionPane.PLAIN_MESSAGE, null, null, "");
 price=Integer.parseInt(finalPrice);
 }
 catch(NumberFormatException e1)
 {
 JOptionPane.showMessageDialog(windowContent,"Invalid
Entry,Please enter again");
 }
 }
 }
 ...
 Logger.getLogger(modify.class.getName()).log(Level.SEVERE,
null, ex);
 } catch (ClassNotFoundException ex) {
 Logger.getLogger(modify.class.getName()).log(Level.SEVERE,
null, ex);
 }catch(StringIndexOutOfBoundsException ex){
 JOptionPane.showMessageDialog(windowContent,"PLEASE
ENTER A NON-NULL VALUE FOR KEY AND PRESS CONFIRM");
 }catch(NullPointerException ex){
 JOptionPane.showMessageDialog(windowContent, "PLEASE
ENTER NON NULL VALUES FOR START TIME AND END TIME AND
PRESS CONFIRM");
 }}
...
PRESS CONFIRM");
 ...
 {
 JOptionPane.showMessageDialog(windowContent,"PLEASE ENTER
A STRING STARTING FROM 'V' or 'D' or 'S' ");
 }



 String disp="BUS KEY: "+key+"BUS TYPE: "+finalType+"\n"+ "BUS
START TIME: "+finalsTime+"\n"+"BUS END TIME: "+finaleTime+"\n"+
 "TICKET PRICE: "+finalPrice;
 if(success){
 JOptionPane.showMessageDialog(windowContent,disp,"MODIFIED BUS
DETAILS",JOptionPane.PLAIN_MESSAGE);
 ...
 public boolean modtrySug(String uniq) throws IOException,
ClassNotFoundException
 ...
 ArrayList<Sugama> read2 = (ArrayList<Sugama>)
objectinput.readObject();
 ...
 {
 JOptionPane.showMessageDialog(windowContent,"PLEASE ENTER
A KEY OF A BUS WHICH EXISTS AND THEN PRESS CONFIRM");

 JOptionPane.showMessageDialog(windowContent,disp,"KEY
LIST",JOptionPane.INFORMATION_MESSAGE);
 ...
 public boolean modtryDur(String uniq) throws IOException,
ClassNotFoundException,NullPointerException
 ...
 ObjectInputStream objectinput = new ObjectInputStream(f);
 ArrayList<Durgamba> read1 = (ArrayList<Durgamba>)
objectinput.readObject();
 objectinput.close();
 boolean exists=false;
 //int flag=0;
...
LIST",JOptionPane.INFORMATION_MESSAGE);
 ...
 public boolean modtryVrl(String uniq) throws IOException,
ClassNotFoundException
 {
