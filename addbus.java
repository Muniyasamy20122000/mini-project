...
Stuff\\NetBeans\\busmodfinal\\bus.jpg").getImage());
 ...
 {
 String[] options={"AC SLEEPER","AC SEMI SLEEPER","NON AC
SLEEPER","AC"};
...
options, options[0]);
 ...
 {
 String[]
options={"00:00","00:30","01:00","01:30","02:00","02:30","03:00","03:30","04:0
0","04:30","05:00","05:30","06:00","06:30","07:00","07:30","08:00","08:30","09:
00","09:30","18:00","18:30","19:00","19:30","20:00","20:30","21:00","21:30","22
:00","22:30","23:00","23:30"};
...
options, options[0]);
 ...
 {
 String[]
options={"Bangalore","Chennai","Kochi","Hyderabad","Manipal"};
...
options, options[0]);
 ...
 {
 String[]
options={"250","300","350","400","450","500","550","600","650","700","750","8
00","850","900"};
...
options, options[0]);
 ...
 {
 String[]
options={"Chennai","Bangalore","Kochi","Hyderabad","Manipal"};
...
ROUTE NO. STARTING WITH THE LETTERS 'V' or 'S' or 'D'");
 }
 if(rtNo.charAt(0)=='V')
 {
 Vrl ob=new Vrl();
 ...
 Logger.getLogger(addBus.class.getName()).log(Level.SEVERE, null,
ex);
...
ex);
 ...
 if(p==1)
 {
 JOptionPane.showMessageDialog(windowContent,"THE BUS HAS
BEEN ADDED");
 Main ob=new Main();
 frame.dispose();
 }
 ...
 {
 JOptionPane.showMessageDialog(windowContent,"ENTER ROUTE
STARTING WITH V/D/S");
 }
 }
 ...
 public void addtryDur(Durgamba ob) throws IOException,
ClassNotFoundException
 ...
 ObjectInputStream objectinput = new ObjectInputStream(f);
 ArrayList<Durgamba> read = (ArrayList<Durgamba>)
objectinput.readObject();
 ...
 public void addtrySug(Sugama ob) throws IOException,EOFException,
ClassNotFoundException
 {
 ...
 ObjectInputStream objectinput = new ObjectInputStream(f);
 ArrayList<Sugama> read = (ArrayList<Sugama>)
objectinput.readObject();
 objectinput.close();
 //obj.adddetails();
 read.add(ob);
