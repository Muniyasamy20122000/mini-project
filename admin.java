...
class admin {
 ...
 frame.setIconImage(new ImageIcon("E:\\Projects for codeprojects\\netbeans\\BusMod-master\\bus.jpg").getImage());
 ...
 JOptionPane.showMessageDialog(windowContent, "Incorrect
Password", "PASSWORD ERROR", JOptionPane.PLAIN_MESSAGE);
 }
...
Password", "PASSWORD ERROR", JOptionPane.PLAIN_MESSAGE);
 ...
 JOptionPane.showMessageDialog(windowContent, "Incorrect Username
or Password", "ERROR", JOptionPane.PLAIN_MESSAGE);
 }
 }
 }
