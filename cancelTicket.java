...
//rowno=(String)JOptionPane.showInputDialog(windowContent,"ENTER ROW
NO.","INPUT", JOptionPane.PLAIN_MESSAGE);
 int ck;
 ...
 {
 case 1:
JOptionPane.showMessageDialog(windowContent,"Invalid Route
Number","ERROR",JOptionPane.ERROR_MESSAGE);
 break;
 case 2: JOptionPane.showMessageDialog(windowContent,"Seat
is not occupied","ERROR",JOptionPane.ERROR_MESSAGE);
 break;
 case 3: JOptionPane.showMessageDialog(windowContent,"Ticket
Cancelled","CONFIRMATION",JOptionPane.PLAIN_MESSAGE);
 break;
 }
 }
 else
 JOptionPane.showMessageDialog(windowContent,"Invalid Route
Number","ERROR",JOptionPane.PLAIN_MESSAGE);
 // System.out.println("did something");

 }
 catch (FileNotFoundException ex)
 {
 Logger.getLogger(cancelTicket.class.getName()).log(Level.SEVERE,
null, ex);
 }
...
Row/Column Number","ERROR",JOptionPane.ERROR_MESSAGE);
 }
...
COLUMN NO.","INPUT", JOptionPane.PLAIN_MESSAGE);
