...
public class Page2
{
 ...
 ButtonHandler2 listener2=new ButtonHandler2();//actionListener for
showSeatMatrix
 ...
 //String dvar1;
 String date1;
 Page2(String svar,String dvar,String date) throws IOException,
...
tempAmmenities.setBorder(BorderFactory.createLineBorder(Color.BLACK));
 ...
 frame2.setIconImage(new ImageIcon("C:\\Rohit\\Java
...
// windowContent.add(temp2);
 ...
 {
 //int i=0;
 //JOptionPane.showMessageDialog(windowContent,"Hey","SEAT
MATRIX",JOptionPane.PLAIN_MESSAGE);

 FileInputStream f = null;
 try {
 f = new FileInputStream("VrlTesting.dat");
 } catch (FileNotFoundException ex) {
 Logger.getLogger(Page2.class.getName()).log(Level.SEVERE, null,
ex);
 }
...
CCUPIED","SEAT MATRIX", JOptionPane.PLAIN_MESSAGE);
 ...
 while(true)
 {
 rowno=(String)JOptionPane.showInputDialog(windowContent,"ENTER
THE ROW NO.(0-3) ","INPUT ROW", JOptionPane.QUESTION_MESSAGE);
...
NO.S IN THE RANGE 0-3");
 ...
 while(true)
 {
 colno=(String)JOptionPane.showInputDialog(windowContent,"ENTER
THE COLUMN NO.(0-9) ","INPUT ROW",
...
objectinput3.readObject();
 ...
 {
 JOptionPane.showMessageDialog(windowContent,"BUS NOT
PRESENT ON THIS ROUTE","ERROR",JOptionPane.ERROR_MESSAGE);
 return;
 }
...
if(obj1.seatmatrix[Integer.parseInt(rowno)][Integer.parseInt(colno)]=='X')
 ...
 JOptionPane.showMessageDialog(windowContent,"Occupied Book
...
//BusMod.bookTicket(rno,Integer.parseInt(rowno),Integer.parseInt(colno));
 Page3 ob=new
Page3(rno,Integer.parseInt(rowno),Integer.parseInt(colno),svar1,dvar1,date1);
 frame2.dispose();
 flag=1;
 break;
 }
...
/* public static void main(String[] args)
 {
 //Page2 obj=new Page2();
 System.out.println("Hello");//Page2 ob=new Page2(); // TODO code
