...
class Page3 {
 ...
 frame3.setIconImage(new ImageIcon("C:\\Rohit\\Java
Stuff\\NetBeans\\busmodfinal\\bus.jpg").getImage());
 ...
 //JOptionPane.showMessageDialog(windowContent,display,"TICKET
DETAILS",JOptionPane.PLAIN_MESSAGE);
 try {
 f1();
 } catch (IOException ex) {
 Logger.getLogger(Page3.class.getName()).log(Level.SEVERE, null,
ex);
...
"+inputName.getText()+ "\t GENDER: "+inputGender.getText()+ "\nSOURCE:
...
DETAILS",JOptionPane.PLAIN_MESSAGE);
 ...
 ArrayList<PassDtls> read1 = (ArrayList<PassDtls>)
...
objectinput1.readObject();
 ...
 FileInputStream f = new FileInputStream(f2);
 ObjectInputStream objectinput1 = new ObjectInputStream(f);
 ArrayList<Sugama> read1 = (ArrayList<Sugama>)
objectinput1.readObject();
 objectinput1.close();
 f.close();
 int i=0;
 ...
 //System.out.println(obj.a);//Page2 ob=new Page2(); // TODO code
